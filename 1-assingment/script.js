...
function registerUser(){
    ...
    let affichage_btn=document.getElementById('afficher')
    let user_message = document.getElementById('user_message')
    if(input.value.length >= 3){
        //débloque le bouton pourdessiner et celui pour afficher le dessin dans un nouvel onglet
...
// here the assignement 1 of the project 
